...
- Only three metrics are used to calculate life expectancy and their effect on life expectancy.
- The CSV files don't have statistics/metrics for every country. Additionally, some countries only have statistics for two metrics but may be missing or vice versa.
